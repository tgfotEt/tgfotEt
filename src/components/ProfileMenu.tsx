    ...
    return (
        <>
            ...
            <div className='absolute top-0 right-0 z-[60] w-64 shadow-lg mt-14 mr-3 bg-gray-700 rounded-xl flex flex-col p-2 border-[1px] border-gray-600'>
                <button className='profile-menu-btn' onClick={() => setCurrentPage('userqb')}>My Question Banks</button>
                <button className='profile-menu-btn' onClick={() => setCurrentPage('settings')}>Settings</button>
